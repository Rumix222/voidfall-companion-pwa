...
Toutes les réserves ont une limite maximum de 15. Tout excédent est perdu. ❌ 💬 partiel : seule la production automatisée (produire_<ressource>, voir §3 plus bas) applique ce plafond ; un gain de ressource "à plat" (ex. récompense de carte, Cadre d'Événement) n'est pas encore plafonné.

# 3. PRODUCTION DE RESSOURCES 
Vous avez cinq cadrans de production sur la partie gauche de votre plateau Ressources, chacun correspondant à une ressource donnée. ✅
Chaque cadran affiche deux valeurs. Le chiffre qui apparaît sur le côté gauche du plateau Ressources est le Niveau de Production. ✅
Celui qui apparaît au milieu est le Revenu. ✅
