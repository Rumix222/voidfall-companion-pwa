...
Si, à votre tour, vous surproduisez plusieurs types de ressources, ou la même ressource plusieurs fois, vous gagnez les 3 Influence pour chaque surproduction. ❌
