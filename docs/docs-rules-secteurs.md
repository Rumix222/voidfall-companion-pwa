...
# 1. SECTEURS
Le plateau principal de Voidfall se divise en secteurs hexagonaux. ✅
## 1.1 SECTEURS ADJACENTS ET TEMPÊTES DU NÉANT
Deux secteurs sont adjacents s’ils partagent un bord d’hexagone.✅
Les jetons Tempête du Néant, en revanche, brisent l’adjacence entre deux secteurs. Aucun effet ne peut les déplacer, ni en ajouter, ni les retirer du plateau.❌
Certaines actions du jeu vous demandent de payer un coût et de résoudre un effet dans le même secteur.✅
## 1.2 CONTRÔLER UN SECTEUR
...
## 1.3 COMPÉTENCES DE SECTEUR
Les secteurs spéciaux ont une ou plusieurs compétences imprimées sur leur hexagone. Ces compétences sont toujours actives lorsque vous contrôlez ce secteur.❌
Si vous envahissez un secteur avec succès, les compétences imprimées s’appliquent immédiatement lors des conséquences de l’Invasion. ❌
Certaines compétences se déclenchent une seule fois, immédiatement après que vous avez envahi le secteur. ❌
Ces effets doivent être pris en compte lors de la résolution des conséquences de l’Invasion (voir consequence de l'invasion). ❌
## 1.4 SECTEURS PURS ET CORROMPUS
...
## 2.1 Guildes ✅
Il existe 5 types de Guildes, chacune augmentant la production de l’unique ressource qui leur correspond. ✅
- Les Guildes de Fermiers augmentent la production de Nourriture ✅
- Les Guildes d’Ingénieurs augmentent la production d’Énergie ✅
- Les Guildes de Mineurs augmentent la production de Matériel ✅
- Les Guildes de Banquiers augmentent la production de Crédits ✅
- Les Guildes de Scientifques augmentent la production de Science ✅
## 2.2 Installations
...
Chaque secteur dispose d’un certain nombre d’emplacements pour accueillir les Installations et Guildes ; en général, trois de chaque. ✅
Les jetons Guilde ne peuvent pas être placés dans les emplacements réservés aux Installations, et inversement. ✅
Vous devez placer les jetons de gauche à droite, en terminant par l’emplacement marqué de l’icône d’Entretien. ✅
Si vous n’avez pas d’emplacements restants pour une infrastructure, vous ne pouvez pas la construire ou l’établir dans ce secteur. ✅
