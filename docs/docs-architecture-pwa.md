...
| `choisirTechnologieAvancee` | `(partieId, slot, nomTechnologie)` | Une des 4 Technologies avancées (slot 0-3), cycle 1 uniquement, rejette les doublons — pool = 8 des maisons déchues + la Technologie de départ du joueur (`technologiesAdversesToutes_`) |
